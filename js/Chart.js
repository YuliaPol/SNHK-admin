                ...
                function (t, e, a) {
                    ...
                    function B(t) {
                        var e,
                            ...
                            s = t[2];
                        return (
                            o <= 8 ? ((a = (100 * o) / 903.3), (n = 7.787 * (a / 100) + 16 / 116)) : ((a = 100 * Math.pow((o + 16) / 116, 3)), (n = Math.pow(a / 100, 1 / 3))),
                                        ...
                                        e.each(
                                            ...
                                            function (e, a) {
                                                ...
                                                o.bar &&
                                                    ...
                                                    (i.options.stacked === !1 || (i.options.stacked === !0 && n.indexOf(o.stack) === -1) || (void 0 === i.options.stacked && (void 0 === o.stack || n.indexOf(o.stack) === -1))) &&
                                                    n.push(o.stack);
                                            },
                                            t
                                        ),
                                    ...
                                    for (a = 0; a < t; ++a)
                                        (e = this.chart.getDatasetMeta(a)),
                                            e.bar &&
                                                ...
                                                (o.options.stacked === !1 || (o.options.stacked === !0 && r.indexOf(e.stack) === -1) || (void 0 === o.options.stacked && (void 0 === e.stack || r.indexOf(e.stack) === -1))) &&
                                                r.push(e.stack);
                                    return r.length - 1;
                                },
                            ...
                            (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                                ...
                                update: function (t) {
                                    ...
                                    if (f < 2 * Math.PI) {
                                        ...
                                        (u = Math.min(s / C.width, l / C.height)), (d = { x: (w.x + M.x) * -0.5, y: (w.y + M.y) * -0.5 });
                                    }
                                ...
                                updateElement: function (t, a, i) {
                                    ...
                                    this.removeHoverStyle(t),
                                        (i && l.animateRotate) || (0 === a ? (b.startAngle = s.rotation) : (b.startAngle = n.getMeta().data[a - 1]._model.endAngle), (b.endAngle = b.startAngle + b.circumference)),
                                        t.pivot();
                                },
                                removeHoverStyle: function (e) {
                                    ...
                                    (i = r[e]),
                                        ...
                                        i.model.skip ||
                                            ...
                                            (o.almostEquals(i.deltaK, 0, this.EPSILON)
                                                ? (i.mK = n.mK = 0)
                                                : ((u = i.mK / i.deltaK), (d = n.mK / i.deltaK), (h = Math.pow(u, 2) + Math.pow(d, 2)), h <= 9 || ((c = 3 / Math.sqrt(h)), (i.mK = u * c * i.deltaK), (n.mK = d * c * i.deltaK))));
                                var f;
                                for (e = 0; e < s; ++e)
                                    (i = r[e]),
                                        i.model.skip ||
                            ...
                            easeInOutElastic: function (t) {
                                ...
                                return 0 === t
                                    ...
                                    : (a || (a = 1 * (0.3 * 1.5)),
                                      ...
                                      t < 1 ? -0.5 * (i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a)) : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / a) * 0.5 + 1);
                            },
                    ...
                    e.exports = function (t) {
                        ...
                        t.layoutService = {
                            ...
                            update: function (t, a, i) {
                                ...
                                function s(t) {
                                    t.isHorizontal()
                                        ? ((t.left = t.options.fullWidth ? d : F), (t.right = t.options.fullWidth ? a - c : F + C), (t.top = E), (t.bottom = E + t.height), (E = t.bottom))
                                        : ((t.left = N), (t.right = N + t.width), (t.top = R), (t.bottom = R + I), (N = t.right));
                                }
                                if (t) {
                        ...
                        (t.defaults.scale = {
                            ...
                            (t.Scale = t.Element.extend({
                                ...
                                fit: function () {
                                    ...
                                    if (
                                        (d ? (n.width = t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth) : (n.width = u && l.drawTicks ? f : 0),
                                        ...
                                        if (d) {
                                            ...
                                            var k = t.ticks[0],
                                                ...
                                                w = e(t.ctx, M, c.font);
                                            0 !== t.labelRotation
                                                ? ((t.paddingLeft = "bottom" === o.position ? b * S + 3 : b * m + 3), (t.paddingRight = "bottom" === o.position ? b * m + 3 : b * w + 3))
                                                ...
                                                if (void 0 !== t && null !== t) {
                                                    ...
                                                    if ((!l || s) && void 0 !== t && null !== t) {
                                                        ...
                                                        a === ("undefined" != typeof n.zeroLineIndex ? n.zeroLineIndex : 0)
                                                            ...
                                                            : ((u = i.getValueAtIndexOrDefault(c.lineWidth, a)), (h = i.getValueAtIndexOrDefault(c.color, a)));
                                                        var g,
                                                            m,
                                                            v,
                                                            k,
                                                        ...
                                                        if (p) {
                                                            "bottom" === o.position
                                                                ? ((O = f ? "middle" : "top"), (R = f ? "right" : "center"), (V = n.top + b))
                                                                : ((O = f ? "middle" : "bottom"), (R = f ? "left" : "center"), (V = n.bottom - b));
                            ...
                            (t.Tooltip = t.Element.extend({
                                ...
                                drawCaret: function (t, a, i) {
                                    var n,
                                        ...
                                        x = a.height;
                                    "center" === p
                                        ? ("left" === g ? ((n = m), (o = n - h), (r = n)) : ((n = m + b), (o = n + h), (r = n)), (l = v + x / 2), (s = l - h), (u = l + h))
                                        : ("left" === g ? ((n = m + f), (o = n + h), (r = o + h)) : "right" === g ? ((n = m + b - f), (o = n - h), (r = o - h)) : ((o = m + b / 2), (n = o - h), (r = o + h)),
                                          "top" === p ? ((s = v), (l = s - h), (u = s)) : ((s = v + x), (l = s + h), (u = s))),
                                ...
                                draw: function () {
                                                ...
                                                0 === c
                                                    ...
                                                    : ((f = d === -1 ? f : u[d]),
                                                      g.skip
                                                          ...
                                                          : (d !== c - 1 ? (o && d !== -1 ? t(f, h) : s ? l.lineTo(g.x, g.y) : (l.lineTo(g.x, r), l.lineTo(g.x, g.y))) : t(f, h), (d = c)));
                                    ...
                                    for (
                                        ...
                                        (h = u[c]),
                                            (f = e.previousItem(u, c)),
                                            (g = h._view),
                                            0 === c ? g.skip || (l.moveTo(g.x, g.y), (d = c)) : ((f = d === -1 ? f : u[d]), g.skip || ((d !== c - 1 && !o) || d === -1 ? l.moveTo(g.x, g.y) : t(f, h), (d = c)));
                                    l.stroke(), l.restore();
                                },
                            }));
                    };
                                ...
                                draw: function () {
                                    ...
                                    if (
                                        (u.horizontal
                                            ...
                                            : ((e = u.x - u.width / 2), (a = u.x + u.width / 2), (i = u.y), (n = u.base), (o = 1), (r = n > i ? 1 : -1), (s = u.borderSkipped || "bottom")),
                                        d)
                                    ) {
                        ...
                        var e = t.helpers,
                            ...
                            i = t.Scale.extend({
                                ...
                                determineDataLimits: function () {
                                    ...
                                    var i;
                                    void 0 !== t.options.ticks.min && ((i = e.indexOf(a, t.options.ticks.min)), (t.minIndex = i !== -1 ? i : t.minIndex)),
                                        void 0 !== t.options.ticks.max && ((i = e.indexOf(a, t.options.ticks.max)), (t.maxIndex = i !== -1 ? i : t.maxIndex)),
                                        (t.min = a[t.minIndex]),
                                        (t.max = a[t.maxIndex]);
                                },
                                buildTicks: function () {
